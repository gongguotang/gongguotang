...
fprintf('\nRunning Preconditioned Conjugate Gradient (L-BFGS preconditioner Default)\n');
options.Method = 'pcg';
options.precFunc = [];
minFunc(@LogisticLoss,w_init,options,X,y);
pause;
...
fprintf('\nRunning Hessian-Free Newton with numerical Hessian-Vector products\n');
options.Method = 'newton0';
minFunc(@LogisticLoss,w_init,options,X,y);
pause;

fprintf('\nRunning Hessian-Free Newton with analytic Hessian-Vector products\n');
options.Method = 'newton0';
...
fprintf('\nRunning Preconditioned Hessian-Free Newton with numerical Hessian-Vector products\n');
...
fprintf('\nRunning Preconditioned Hessian-Free Newton with analytic Hessian-Vector products\n');
options.Method = 'pnewton0';
options.precFunc = [];
options.HvFunc = @LogisticHv;
minFunc(@LogisticLoss,w_init,options,X,y);
